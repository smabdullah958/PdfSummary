    ...
    <div className="min-h-screen bg-slate-50 text-slate-900 font-sans selection:bg-indigo-100">
      ...
      <section className="relative pt-20 pb-16 md:pt-32 md:pb-24 overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-6 text-center">
          {/* Badge */}
          <div className="inline-flex items-center gap-2 bg-white border border-slate-200 px-4 py-1.5 rounded-full shadow-sm mb-8 animate-bounce 2xl:my-32">
          ...
          {/* Main Headline */}
          <h1 className="text-5xl md:text-7xl font-black tracking-tight text-slate-900 mb-6 2xl:mb-20">
            Understand your <span className="text-indigo-600">PDFs</span> <br />
            in seconds.
          </h1>

          {/* Subtext */}
          <p className="text-lg md:text-xl text-slate-600 max-w-2xl mx-auto mb-10 leading-relaxed 2xl:mb-20">
      ...
      {/* --- FOOTER --- */}
      <footer className="text-center py-12 border-t border-slate-300 2xl:mt-20">
